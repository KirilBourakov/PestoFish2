...
MAX_SCORE = 32000
DATA_FILE = "data/329092884.bin"

def extract_encoding(fen: str) -> HalfKP:
    """
...
def parse_all_lichess(input_file: str | Path, output_bin: str | Path):
    """
    ...
    with open(input_file, 'r', encoding='utf-8') as f_in, open(output_bin, 'wb') as f_out:
        for line in tqdm(f_in):
            ...
            fen = data["fen"]
            our_encoding, their_encoding = extract_encoding(fen)
...
if __name__ == "__main__":
    parse_all_lichess("data/lichess_db_eval.jsonl", "data/out.bin")