...
export const std::unordered_map<PieceType, int> middleGameScore{
  { PieceType::Pawn, 84 },    { PieceType::Knight, 333 },
  { PieceType::Bishop, 346 }, { PieceType::Rook, 441 },
  { PieceType::Queen, 921 },
};
export const std::unordered_map<PieceType, int> endGameScore{
  { PieceType::Pawn, 106 },   { PieceType::Knight, 244 },
  { PieceType::Bishop, 268 }, { PieceType::Rook, 478 },
  { PieceType::Queen, 886 },
};
export const std::unordered_map<PieceType, int> normalScore{
  { PieceType::Pawn, 1 }, { PieceType::Knight, 3 }, { PieceType::Bishop, 3 },
  { PieceType::Rook, 5 }, { PieceType::Queen, 9 },
};
