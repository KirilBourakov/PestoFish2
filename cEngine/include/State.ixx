...
public:
  struct HistoricalEntry
  {
    ...
    {
      return other.move == move && other.movedPiece == movedPiece &&
             other.overwrittenPiece == overwrittenPiece &&
             castlingBeforeMove == other.castlingBeforeMove &&
             halfMoveClockBeforeMove == other.halfMoveClockBeforeMove &&
  ...
  void translateAndMove(BoardPosition start,
                        BoardPosition end,
  ...
  {
    const BoardPosition kingSquare =
      color == Color::White ? whiteKingSquare : blackKingSquare;
