...
PYBIND11_MODULE(cEngine, m)
{
  ...
  py::class_<State>(m, "State")
    .def(
      "getBoard", &State::getBoard, py::return_value_policy::reference_internal)
  ...
  Piece.attr("WHITE_KNIGHT") =
    Pieces::make_piece(Color::White, PieceType::Knight);
  Piece.attr("WHITE_BISHOP") =
    Pieces::make_piece(Color::White, PieceType::Bishop);
  Piece.attr("WHITE_ROOK") = Pieces::make_piece(Color::White, PieceType::Rook);
  Piece.attr("WHITE_QUEEN") =
    Pieces::make_piece(Color::White, PieceType::Queen);
  ...
  Piece.attr("BLACK_KNIGHT") =
    Pieces::make_piece(Color::Black, PieceType::Knight);
  Piece.attr("BLACK_BISHOP") =
    Pieces::make_piece(Color::Black, PieceType::Bishop);
  Piece.attr("BLACK_ROOK") = Pieces::make_piece(Color::Black, PieceType::Rook);
  Piece.attr("BLACK_QUEEN") =
    Pieces::make_piece(Color::Black, PieceType::Queen);
