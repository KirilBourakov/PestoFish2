...
from engine.src.evaluator.heuristics.development import development_eval
from engine.src.evaluator.heuristics.piece_mobility import piece_mobility

independant: list[Callable[[str, tuple[int, int], bool], int]] = [material_eval, piece_position, development_eval]
